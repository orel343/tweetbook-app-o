...
import { faHome, faUser, faBell, faComment } from '@fortawesome/free-solid-svg-icons';  // Imported faBell for the notification icon
...
const pages = [
  ...
  {
    link: '/notification',
    icon: faBell,  // Changed icon for Notification page
    title: 'Notification',
  }
];
